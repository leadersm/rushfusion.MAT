...
public class ItemDetailPage2 extends Activity{
	ImageView image;
	TextView name;
	...
	List<String> list;
	Movie movie = new Movie(1, 1, 80, 1364, 334, "movie", "栗洋的生活", "家庭;伦理", 2012, "栗洋", "栗洋;王英", "大陆", "栗洋一家的生活，以及一年以来的变故", "http://tp4.sinaimg.cn/2010098347/50/5600263031/1", "01:51:58", "http://v.iask.com/v_play_ipad.php?vid=33184708");
		...
		episode.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				if(path.indexOf("html")==(path.length()-4)){
					...
					Intent it =  new Intent(ItemDetailPage2.this, MediaPlayerShow.class);
