...
//		recommendPage.loadPage("url?data?鈥︹�BD",R.layout.page_recommend);
//		recommendPage.setPageCache(recommendPage, R.layout.page_recommend);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.leshi:
//			updateLastWatchRecord("涔愯");
			changeDataByOriginName("leshi");
			break;
		case R.id.qiyi:
//			updateLastWatchRecord("濂囪壓");
			changeDataByOriginName("qiyi");
			break;
		case R.id.souhu:
//			updateLastWatchRecord("鎼滅嫄");
			changeDataByOriginName("souhu");
			break;
		case R.id.tudou:
//			updateLastWatchRecord("鍦熻眴");
			changeDataByOriginName("tudou");
			break;
//		case R.id.sina:
////			updateLastWatchRecord("鏂版氮");
